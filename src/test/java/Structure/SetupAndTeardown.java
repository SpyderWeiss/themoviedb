...
public class SetupAndTeardown {
    ...
    {
        Logging.log("Beginning test suite.");
    }

    /**
     * This method runs anything needed before each individual test is run
     * Configures a logger (BasicConfigurator)
     * Creates a ValidatableResponse interface that is passed into the Validation class
    ...
    public static Validation beforeTest(String url, String title)
    {
        ...
        //If title isn't null, we need to append the title on to the end of the url and replace the spaces with
