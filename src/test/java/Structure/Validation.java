 ...
 * Used to validate all returned JSON data, could be broken up into more specific types of validation as the suite grows.
 */
public class Validation {
     ...
     * @param expectedResultNumber - The position in the returned JSON array the entry should be in.
